...
const S={
  ...
  iconBtn:    {width:32,height:32,borderRadius:8,border:"none",cursor:"pointer",fontSize:12,fontWeight:700,display:"flex",alignItems:"center",justifyContent:"center"},
  ...
  modal:      {background:"var(--card-bg, #0d1118)",border:"1px solid var(--border, #111820)",borderTopLeftRadius:20,borderTopRightRadius:20,padding:"8px 18px 36px",width:"100%",maxWidth:480,maxHeight:"92vh",overflowY:"auto"},
